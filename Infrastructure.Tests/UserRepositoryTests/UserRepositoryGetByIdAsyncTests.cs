...
public class UserRepositoryGetByIdAsyncTests
{
    ...
    public async Task WhenGettingByIdAsync_ShouldReturnCorrectUser(string stringId, bool expected)
    {
        // Arrange
        ...
        // Act
        var result = await userRepository.GetByIdAsync(Guid.Parse(stringId));
